...
class User(Base):
    ...
    # Professionnel (médecins)
    rpps_number = Column(String(11), unique=True, nullable=True)  # Numéro RPPS
    specialty = Column(String(100), nullable=True)  # Spécialité
    establishment = Column(String(255), nullable=True)  # Établissement
